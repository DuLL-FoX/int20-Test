...
export default function AuctionUpdateForm() {
  const form = useForm<updateAuctionValues>({
  ...
  const onSubmit = async (values: updateAuctionValues) => {
  ...
  return (
    <main className="max-w-3xl m-auto my-10 space-y-10">
      <div className="space-y-5 text-center">
        <H1>Оновлення даних аукціону аукціону</H1>
